...
window.addEventListener('load', async () => {
  ...
  function mergelocalNDBAttractions(savedAttractionsDB) {
    const localSavedAttractions = parseJSON(localStorage['ak-attractions-saved']);
    const savedAttractions = parseJSON(savedAttractionsDB); 

    if (!localSavedAttractions || !savedAttractions) {
      console.log('Missing localSavedAttractions or savedAttractions!')
      return;
    }
