...
window.addEventListener('load', async () => {
  ...
  function mergelocalNDBAttractions(savedAttractionsDB) {
    ...
    for (const [slide, attractions] of Object.entries(savedAttractions)) {
        ...
        let savedMorningArr = morning; // savedAttractions[slide].morning;
        let savedAfternoonArr = afternoon; // savedAttractions[slide].afternoon;
        let savedEveningArr = evening; // savedAttractions[slide].evening;
