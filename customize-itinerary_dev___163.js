...
window.addEventListener('load', async () => {
  ...
  if (Clerk.user) { // logged-in user retrieve from DB
    ...
    if (!data) {  // user has no saved record in the db
      ...
      //   || arrivalAirport 
      //   || departureAirport 
      //   || localStorage['ak-travel-days-update']) {
    ...
    if (referrerMail) {
      ...
      console.log('userArrivalAirport', userArrivalAirport)
      console.log('userDepartureAirport', userDepartureAirport)
...
function setupHotelNAirports(hotel, arrivalAirport, departureAirport) {
  ...
  function processLocation(locationDetails, $resultWrapName) {
    // console.log('localStorage[localStorageName]', localStorage[localStorageName])
    // console.log('$resultWrapName', $resultWrapName)
