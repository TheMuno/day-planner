...
function setupHotelNAirports(hotel, arrivalAirport, departureAirport) {
  ...
  function setupLocation(location, locationDetails, $resultWrap) {
    ...
    if (location === hotel) {
      ...
      const markerPinUrl = getCorrectTransportationPinUrl(displayName);
...
/*function submitUserDetailsToWebflowForm(CreatedAt, ModifiedAt, hotel, arrivalAirport, departureAirport, tripName, travelDates, savedAttractions) {
  ...
  let $createAtSubmit = $submitUserDetailsForm.querySelector('[data-ak="created-at-submit"]');
  let $modifiedAtSubmit = $submitUserDetailsForm.querySelector('[data-ak="modified-at-submit"]');
  let $hotelSubmit = $submitUserDetailsForm.querySelector('[data-ak="hotel-submit"]');
  let $arrivalAirportSubmit = $submitUserDetailsForm.querySelector('[data-ak="arrival-airport-submit"]');
  let $departureAirportSubmit = $submitUserDetailsForm.querySelector('[data-ak="departure-airport-submit"]');
  let $tripNameSubmit = $submitUserDetailsForm.querySelector('[data-ak="trip-name-submit"]');
  let $travelDatesSubmit = $submitUserDetailsForm.querySelector('[data-ak="travel-dates-submit"]');
  let $savedAttractionsSubmit = $submitUserDetailsForm.querySelector('[data-ak="saved-attractions-submit"]');
...
!async function setupHotelAutocomplete() {
  ...
  placeAutocomplete.addEventListener('gmp-select', async (res) => {
    ...
    // console.log("markerObj['hotel']", markerObj['hotel'])
...
function getCorrectTransportationPinUrl(displayName) {
