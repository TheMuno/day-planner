...
window.addEventListener('load', async () => {
  ...
  if (Clerk.user) { // logged-in user retrieve from DB
    ...
    if (referrerMail) {
      ...
      let userTravelDates, userHotel, userArrivalAirport, userDepartureAirport;
      if (localStorage['ak-update-travel-days']) {
      ...
      setupUserInfo(savedAttractions, tripName, userTravelDates, userHotel, userArrivalAirport, userDepartureAirport);
      localStorage.removeItem('ak-referred');
