...
const $generateItineraryList = document.querySelector('[data-ak="generate-text-file"]');
$generateItineraryList.addEventListener('click', e => {
  window.location.href = '/itinerary-list';
});
