...
window.addEventListener('load', async () => {
  ...
  // console.log('addedAttractions starting...', addedAttractions) 
  ...
  $toggleAttractionsWrap?.addEventListener('click', async e => {
    ...
    if (e.target.n % 2 === 0) {  
      ...
      // console.log('added stored markers!')
      attractionMarkers.forEach(marker => marker.setMap(map));
    }
    else {   
      // console.log('added fresh markers!')
  ...
  if (Clerk.user) { // logged-in user retrieve from DB
    ...
    // console.log('addedAttractions gone!!') 
  ...
  function mergelocalNDBAttractions(savedAttractionsDB) {
    ...
    for (const [slide, attractions] of Object.entries(savedAttractions)) {
      ...
      // console.log('savedMorningArr', savedMorningArr)
      // console.log('localMorningArr', localMorningArr)
...
$calculatePasses.addEventListener('click', async e => {
  ...
  if (gocityNum >= 10) {
    ...
    if (exactPass) {
      ...
      console.log('=============================')
      console.log('All Inclusive Pass:', exactPass[1].pass_name)
      console.log('Price:', `$${exactPass[1].pass_price}`)  
      console.log('=============================')
      showExtraPass($gocityName, $gocityPrice, exactPass, true);
      console.log('$gocityName', $gocityName)
      ...
      if (passLowerLimit && passLowerLimit.length) {
        ...
        console.log('=============================')
        console.log('No Exact All Inclusive Pass')
        console.log('All Inclusive Lower Limit Pass:', passLowerLimit[1].pass_name)
        console.log('Price:', `$${passLowerLimit[1].pass_price}`)  
        console.log('=============================')
      ...
      //   console.log('=============================')
      //   console.log('All Inclusive Upper Limit Pass:', passUpperLimit[1].pass_name)
      //   console.log('Price:', `$${passUpperLimit[1].pass_price}`)  
      //   console.log('=============================')
      // }
    }
  }
  ...
  function resetPassCalc() {
    document.querySelectorAll('[data-ak="pass-info"]').forEach(passInfo => {
      ...
      $passName.textContent = $passName.textContent.replace(/\d/, '');
