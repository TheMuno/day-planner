...
window.addEventListener('load', async () => {
  ...
  function handleRemoveLocation(e) {
    ...
    // else {
      ...
      console.log("e.target.closest('[data-ak-timeslot-wrap]')", e.target.closest('[data-ak-timeslot-wrap]'))
      console.log('$removeBtn', $removeBtn)
      console.log("$removeBtn.closest('[data-ak-timeslot-wrap]')", $removeBtn.closest('[data-ak-timeslot-wrap]'))
      console.log('parents', $removeBtn.parentElement.parentElement.parentElement)
