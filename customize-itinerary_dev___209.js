...
window.addEventListener('load', async () => {
  ...
  if (Clerk.user) { // logged-in user retrieve from DB
    ...
    if (referrerMail) {
      ...
      console.log("localStorage['ak-update-travel-days']", localStorage['ak-update-travel-days'])
      console.log("localStorage['ak-travel-days']", localStorage['ak-travel-days'])
      console.log('travelDates', travelDates)

      const userTravelDates = localStorage['ak-update-travel-days'] ? localStorage['ak-travel-days'] : travelDates;

      console.log("2) localStorage['ak-update-travel-days']", localStorage['ak-update-travel-days'])
      console.log("2) localStorage['ak-travel-days']", localStorage['ak-travel-days'])
      console.log('2) travelDates', travelDates)
      console.log('userTravelDates', userTravelDates)
