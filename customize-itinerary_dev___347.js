...
const $headToItineraryList = document.querySelector('[data-ak="generate-text-file"]');
$headToItineraryList.addEventListener('click', e => {
  const userMail = localStorage['ak-userMail'];
  let userId;
  if (userMail) {
    userId = encodeURIComponent(userMail);
  }
