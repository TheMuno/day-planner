...
function setupTravelDates(flatpickrDate) {
  ...
  function setupSliderDates() {
    ...
    console.log("$attractionsSliderMask.querySelectorAll('.w-slide')", $attractionsSliderMask.querySelectorAll('.w-slide'))
    console.log("$attractionsSliderMask.querySelectorAll('.w-slide')[1]", $attractionsSliderMask.querySelectorAll('.w-slide')[1])
